...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__constants_api_constants__ = __webpack_require__(54);
...
var QuantityCalcPage = (function () {
    ...
    QuantityCalcPage.prototype.ngOnInit = function () {
        ...
        this.api.fetchService("points").then(function (points) {
            ...
            console.log("Storing new Points", _this.points);
            _this.api.storeService(__WEBPACK_IMPORTED_MODULE_7__constants_api_constants__["h" /* POINTS */], _this.points);
            if (!_this.enable) {
                _this.presentGetPoints();
            }
            console.log("Existing points", _this.points);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__constants_api_constants__ = __webpack_require__(54);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp.prototype.ngOnInit = function () {
        ...
        this.api.fetchService(__WEBPACK_IMPORTED_MODULE_9__constants_api_constants__["h" /* POINTS */]).then(function (points) {
            console.log("Points", points);
            if (points == null) {
                _this.api.storeService(__WEBPACK_IMPORTED_MODULE_9__constants_api_constants__["h" /* POINTS */], 2);
            }
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants_api_constants__ = __webpack_require__(54);
...
var ApiDataProvider = (function () {
    ...
    ApiDataProvider.prototype.prepareVideoAd = function (show) {
        ...
        this.admobFree.on("admob.rewardvideo.events.LOAD_FAIL").subscribe(function (res) {
            console.log("AD failed to Load - new", res);
            _this.prepareVideoAd();
        });
        this.admobFree.on("admob.rewardvideo.events.LOAD").subscribe(function (res) {
                ...
                _this.admobFree.rewardVideo.show().then(function (res) {
                    ...
                    _this.admobFree.on("admob.rewardvideo.events.REWARD").subscribe(function (res) {
                        _this.fetchService("points").then(function (points) {
                            ...
                            newPoints += 5;
                            _this.storeService(__WEBPACK_IMPORTED_MODULE_5__constants_api_constants__["h" /* POINTS */], newPoints);
                            console.log("Earned New points", newPoints);
                        });
                        console.log("Successful view - reward", res);
                        _this.prepareVideoAd();
                    });
                    _this.admobFree.on("admob.rewardvideo.events.START").subscribe(function (res) {
                    ...
                    _this.admobFree.on("admob.rewardvideo.events.OPEN").subscribe(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_api_constants__ = __webpack_require__(54);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
